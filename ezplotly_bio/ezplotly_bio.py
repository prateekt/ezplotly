...
def manhattan_plot(df: pd.DataFrame, title: Optional[str] = None, height: Optional[int] = None,
                   withhold: bool = False, outfile: Optional[str] = None) -> Optional[List[EZPlotlyPlot]]:
    """
    ...
    for chrs in range(1, 25):
        ...
        figs_list.append(ep.scattergl(pts_x, pts_y, name=chr_name, ylabel='-log10(p)',
                                      title=title, marker_size=3))
        cnt = cnt + len(chr_df)
    ...
    if withhold:
        ...
        ep.plot_all(figs_list, panels=panels, numcols=1, showlegend=True, height=height, outfile=outfile)


def chr_rolling_median(chr_pos_df: pd.DataFrame, chr_val_df: pd.DataFrame, rollwinsize: int,
                       ylabel: Optional[str] = None, title: Optional[str] = None,
                       xlim: Optional[List[int]] = None, ylim: Optional[List[int]] = None,
                       withhold: bool = False, outfile: Optional[str] = None) -> Optional[EZPlotlyPlot]:
    """
...
def chr_count(bool_vals: pd.DataFrame, chr_df: pd.DataFrame, title: Optional[str] = None,
              withhold: bool = False, outfile: Optional[str] = None) -> Optional[EZPlotlyPlot]:
    """
...
def chr_distr(data: pd.DataFrame, chr_df: pd.DataFrame, distr_name: str, title: Optional[str] = None,
              withhold: bool = False, outfile: Optional[str] = None) -> Optional[EZPlotlyPlot]:
    """
...
def chr_hist(df: pd.DataFrame, data_col_name: str, min_bin: Optional[float] = None,
             max_bin: Optional[float] = None, bin_size: Optional[int] = None,
             title: Optional[str] = None, xlabel: Optional[str] = None, ylabel: Optional[str] = None,
             histnorm: Optional[str] = None, x_dtick: Optional[List[int]] = None,
             y_dtick: Optional[List[int]] = None, withhold: bool = False, outfile: Optional[str] = None) \
    ...
    for u_chr in chrs_list:
        if u_chr in uniq_vals:
            ...
            ep_hist = ep.hist(data, title=u_chr, xlabel=xlabel, min_bin=min_bin, max_bin=max_bin, bin_size=bin_size,
...
def chr_qq(df: pd.DataFrame, data_col_name: str, distr: str = 'norm', sparams: List = (),
           title: Optional[str] = None, withhold: bool = False, outfile: Optional[str] = None) \
        -> Optional[List[EZPlotlyPlot]]:
    """
...
def qqplot(data: Sequence[float], distr: str = 'norm', sparams: List[Any] = (), title: Optional[str] = None,
           name: Optional[str] = None, marker_color: str = 'blue', line_color: str = 'red', withhold: bool = False,
           outfile: Optional[str] = None) -> Optional[Tuple[EZPlotlyPlot, EZPlotlyPlot]]:
    """
    ...
    pts_scatter = ep.scattergl(x=qq[0][0], y=qq[0][1], title=title, xlabel='Expected', ylabel='Observed', marker_size=5,
...
def roc(preds: np.array, gt: np.array, panel: int = 1, names: Optional[List[str]] = None, title: Optional[str] = None,
        xscale: Optional[str] = None, yscale: Optional[str] = None, withhold: bool = False,
        outfile: Optional[str] = None) -> Optional[Tuple[List[EZPlotlyPlot], List[int]]]:
    """
...
def ecdf(data: np.array, min_bin: Optional[float] = None, max_bin: Optional[float] = None,
         bin_size: Optional[float] = None, title: Optional[str] = None, xlabel: Optional[str] = None,
         ylabel: Optional[str] = None, norm: bool = False, name: Optional[str] = None, xscale: Optional[str] = None,
         yscale: Optional[str] = None, x_dtick: Optional[List[int]] = None, y_dtick: Optional[List[int]] = None,
         color: Optional[str] = None, withhold: bool = False, outfile: Optional[str] = None) -> Optional[EZPlotlyPlot]:
    """
    ...
    counts, bin_edges = np.histogram(data, bins=np.arange(min_bin, max_bin + bin_size, bin_size))
    ...
    if not norm:
        ...
        cdf_line = ep.line(x=bin_edges[:-1], y=counts_sum * cdf, title=title, xlabel=xlabel, ylabel=ylabel,
                           xlim=[min_bin, max_bin + bin_size], name=name, xscale=xscale, yscale=yscale, x_dtick=x_dtick,
                           y_dtick=y_dtick, color=color)
    else:
        if ylabel is None:
            ylabel = 'CDF'
        cdf_line = ep.line(x=bin_edges[:-1], y=cdf, title=title, xlabel=xlabel, ylabel=ylabel,
                           xlim=[min_bin, max_bin + bin_size], ylim=[0, 1.0], name=name, xscale=xscale, yscale=yscale,
...
def rcdf(data: np.array, min_bin: Optional[float] = None, max_bin: Optional[float] = None,
         bin_size: Optional[float] = None, title: Optional[str] = None, xlabel: Optional[str] = None,
         ylabel: Optional[str] = None, norm: bool = False, name: Optional[str] = None,
         xscale: Optional[str] = None, yscale: Optional[str] = None, x_dtick: Optional[List[int]] = None,
         y_dtick: Optional[List[int]] = None, color: Optional[str] = None, withhold: bool = False,
         outfile: Optional[str] = None) -> Optional[EZPlotlyPlot]:
    """
    ...
    if not norm:
        ...
        cdf_line = ep.line(x=bin_edges[:-1], y=np.round(counts_sum * (1.0 - cdf), 5), title=title, xlabel=xlabel,
                           ylabel=ylabel, xlim=[min_bin, max_bin + bin_size], name=name, xscale=xscale, yscale=yscale,
                           x_dtick=x_dtick, y_dtick=y_dtick, color=color)
    else:
        if ylabel is None:
            ylabel = 'CDF'
...
def corr_plot(x: np.array, y: np.array, error_y: Optional[Sequence[float]] = None, xlabel: Optional[str] = None,
              ylabel: Optional[str] = None, title: Optional[str] = None,
              name: Optional[str] = None, xscale: Optional[str] = None, yscale: Optional[str] = None,
              x_dtick: Optional[float] = None, y_dtick: Optional[float] = None, xlim: Optional[List[float]] = None,
              ylim: Optional[List[float]] = None, plot_type: str = 'scatter', withhold: bool = False,
              outfile: Optional[str] = None) -> Optional[EZPlotlyPlot]:
    """
    ...
    if plot_type == 'scatter':
        plot = ep.scattergl(x=x, y=y, error_y=error_y, xlabel=xlabel, ylabel=ylabel, title=title, name=name,
                            xscale=xscale, yscale=yscale, x_dtick=x_dtick, y_dtick=y_dtick, xlim=xlim, ylim=ylim)
    elif plot_type == 'line':
        plot = ep.line(x=x, y=y, error_y=error_y, xlabel=xlabel, ylabel=ylabel, title=title, name=name,
                       xscale=xscale, yscale=yscale, x_dtick=x_dtick, y_dtick=y_dtick, xlim=xlim, ylim=ylim)
    else:
...
def nonparametric_ci(x: np.array, y_data: np.array, conf: float = 0.95, ci_plot_type: str = 'line',
                     color: Optional[str] = None, xlabel: Optional[str] = None, ylabel: Optional[str] = None,
                     title: Optional[str] = None, name: Optional[str] = None, xscale: Optional[str] = None,
                     yscale: Optional[str] = None, x_dtick: Optional[float] = None, y_dtick: Optional[float] = None,
                     xlim: Optional[List[float]] = None, ylim: Optional[List[float]] = None, withhold: bool = False,
                     outfile: Optional[str] = None) -> Union[List[EZPlotlyPlot], EZPlotlyPlot]:
    """
    ...
    if ci_plot_type == 'line':
        ...
        # gen EZPlotlyPlot
        plot = ep.line(x=x, y=m, ucl=np.abs(ul - m), lcl=np.abs(ll - m), color=color, name=name, xlabel=xlabel,
                       ylabel=ylabel, title=title, xscale=xscale, yscale=yscale, x_dtick=x_dtick, y_dtick=y_dtick,
                       xlim=xlim, ylim=ylim)
